...
namespace AcroCore
{
	...
	struct IGL
	{
		...
		//enum class EColorMaterialParameter
		//{
		//	GL_AMBIENT,
		//	GL_DIFFUSE,
		//	GL_SPECULAR,
		...
		//enum class ELightModelParameter
		//{
		...
		//enum class EMeshMode1
		//{
		//	GL_POINT,
		//	GL_LINE,
		//};

		//enum class EMeshMode2
		//{
		//	GL_POINT,
		//	GL_LINE,
		//  GL_FILL,
		...
		//enum class ETexCoordPointerType
		//{
		//	GL_SHORT,
		//	GL_INT,
		//	GL_FLOAT,
